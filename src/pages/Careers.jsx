      ...
      <>
        <div className="bg-white jost relative" style={{ minHeight: "100vh" }}>
          ...
          <div className="    items-center  flex-col  -space-y-24 relative justify-center  h-screen   flex px-10">
            <img src={hand} className="w-[100px] md:w-[150px] absolute   z-[1]  left-1/4 ml-20 top-28" alt="TV" />
            <img src={ufo} className="w-[100px] md:w-[150px] absolute   z-[20]  right-1/4    top-1/2" alt="TV" />
            <h1 className=' font-[1000] text-[260px]  alinsa text-[#0000FF]  z-[10]'>CAREERS</h1>
                  <p className=' jost  font-[500]  lowercase  text-[60px] z-[10]'>WANNA JOIN THE CHAOS ?</p>
          </div>
        <JobListings />
        <Footer />
        </div>
